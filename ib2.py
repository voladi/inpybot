...
hashtag_list = ['travelling','skyscraper','vacation','beach','geography','city','veganfood','usa','midwest','paradise']

#prev_user_list = [] 
prev_user_list = pd.read_csv('20190521-010252_users_followed_list.csv', delimiter=',').iloc[:,1:2]
